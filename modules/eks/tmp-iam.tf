...
# # # #         ]
# # # #         Resource = "arn:aws:secretsmanager:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:secret:playlist-app-*"
# # # #       }
# # # #     ]
# # # #   })
...
# # # # EXTERNAL SECRETS IAM ROLE - מעודכן לגישה רחבה יותר
# # # resource "aws_iam_role" "external_secrets" {
# # #   name = "${var.cluster_name}-external-secrets-role"
...
# # #           StringEquals = {
# # #             "${replace(aws_iam_openid_connect_provider.eks_oidc.url, "https://", "")}:aud" = "sts.amazonaws.com"
# # #             # הסרתי את ה-:sub condition לבדיקה
# # #           }
# # #         }
# # #       }
# # #     ]
...
# # # # IAM Policy for External Secrets - מעודכן לגישה רחבה יותר
# # # resource "aws_iam_policy" "external_secrets_policy" {
# # #   name        = "${var.cluster_name}-external-secrets-policy"
# # #   description = "Policy for External Secrets to access AWS Secrets Manager"
...
# # #         ]
# # #         Resource = "*"  # גישה לכל הsecrets בשלב הראשון
# # #       }
# # #     ]
# # #   })
...
# #         Condition = {
# #           StringEquals = {
# #             "${aws_eks_cluster.main.identity[0].oidc[0].issuer}:sub" = "system:serviceaccount:external-secrets:external-secrets"
